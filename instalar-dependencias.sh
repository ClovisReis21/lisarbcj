...
CRON_EXPRESSION="0 0-0,2-23 * * * /home/cj/lisarb_jc/job_extracao.sh >> /home/cj/lisarb_jc/saida_extracao.log 2>&1"
(crontab -l ; echo "$CRON_EXPRESSION") | crontab -

echo "Adicionando job ingesta..."
CRON_EXPRESSION="* 1 * * * /home/cj/lisarb_jc/job_ingesta.sh >> /home/cj/lisarb_jc/saida_ingesta.log 2>&1"
(crontab -l ; echo "$CRON_EXPRESSION") | crontab -

echo "Adicionando job batch..."
CRON_EXPRESSION="0 3 * * * /home/cj/lisarb_jc/job_batch_view.sh >> /home/cj/lisarb_jc/saida_batch.log 2>&1"
(crontab -l ; echo "$CRON_EXPRESSION") | crontab -
